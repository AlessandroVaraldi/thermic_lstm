...
# File paths
# --------------------------------------------------------------------
# Full path to the CSV file that contains the original measurement
# data (time, currents, temperatures …).
CSV_FILE = "data_sets/20240913_1446_regimation.csv"  # str
...
PATIENCE      = 5      # int – early-stopping patience on validation loss
BATCH_SIZE    = 8      # int – number of windows per mini-batch
LEARNING_RATE = 1e-3   # float – initial LR for the Adam optimiser
